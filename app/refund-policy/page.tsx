      ...
      <section className="relative pt-32 pb-16 bg-[#040d07] overflow-hidden border-b border-emerald-500/10 text-center">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 z-10">
          ...
          <h1 className="font-[family-name:var(--font-anton)] text-4xl sm:text-6xl md:text-7xl text-white tracking-wide uppercase leading-tight">
            REFUND <span className="text-[#2BA84A]">POLICY</span>
          </h1>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-[#0e2419]/90 border border-emerald-500/30 rounded-3xl p-6 sm:p-8 mb-10 backdrop-blur-xl shadow-xl shadow-black/30">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3.5 mt-6 pt-6 border-t border-emerald-500/15">
              <div className="text-center p-4 bg-[#07170f] border border-emerald-500/20 rounded-2xl">
                <p className="text-2xl font-extrabold text-emerald-400">&gt; 5h</p>
                <p className="text-[11px] text-slate-300 mt-1 font-medium">Eligible Cancellation Window</p>
              </div>
              <div className="text-center p-4 bg-[#07170f] border border-emerald-500/20 rounded-2xl">
                <p className="text-2xl font-extrabold text-white">5-7</p>
                <p className="text-[11px] text-slate-300 mt-1 font-medium">Working Days to Process</p>
              </div>
              <div className="text-center p-4 bg-[#07170f] border border-emerald-500/20 rounded-2xl">
                <p className="text-2xl font-extrabold text-emerald-400">90%</p>
                <p className="text-[11px] text-slate-300 mt-1 font-medium">Direct Source Mode Return</p>
              </div>
            </div>
          </div>
          ...
          <div className="mt-12 bg-[#040d07] border border-emerald-500/20 rounded-3xl p-8 text-center sm:text-left flex flex-col sm:flex-row items-center justify-between gap-6">
            <div>
              <h3 className="text-lg sm:text-xl font-bold text-white">Refund or Payment Queries?</h3>
              <p className="text-xs sm:text-sm text-slate-300 mt-1">
                Reach out to our accounts desk at billing@maqboolsports.in or +91 9682558775.
              </p>
            </div>
            <Link
              href="/contact"
