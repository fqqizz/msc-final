...
const facilities = [
  ...
  },
  {
    ...
    name: 'Cricket Net 1',
    description:
      'Professional practice net designed for batting and bowling practice. Features high-quality netting and adequate space for effective training sessions.',
    price: '₹299/hour',
    image:
  ...
  },
  {
    ...
    name: 'Cricket Net 2',
    description:
      'Second professional practice net ideal for team sessions and group training. Perfect for simultaneous batting and bowling practice.',
    price: '₹299/hour',
    image:
    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="relative pt-32 pb-20 bg-[#050505] overflow-hidden">
        ...
        >
          ...
          >
            Premium turfs and grounds designed for cricket and football, offering top-class facilities and
            dynamic environments for an unmatched playing experience.
          </motion.p>
        </motion.div>
      </section>
            ...
            {facilities.map((facility, index) => (
              ...
              >
                ...
                <div className={`relative ${index % 2 === 1 ? 'lg:order-2' : ''}`}>
                  <motion.div
                    whileHover={
                      isMobile ? {} : { scale: 1.03, rotateX: 4, rotateY: index % 2 === 0 ? -3 : 3 }
                    }
                ...
                <div className={index % 2 === 1 ? 'lg:order-1' : ''}>
                  <h2 className="text-3xl sm:text-4xl font-bold text-[#0A0A0C] mb-4">{facility.name}</h2>
                  <p className="text-[#0A0A0C]/60 text-lg mb-6">{facility.description}</p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {highlights.map((highlight) => (
              <div key={highlight.title} className="bg-white p-6 rounded-2xl border border-[#0A0A0C]/5">
      ...
      <section className="py-24 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl sm:text-4xl font-bold text-[#0A0A0C] tracking-tight mb-6">Ready to Play?</h2>
